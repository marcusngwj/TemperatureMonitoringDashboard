...
import { ROOM_ID, ROOM_COLOR } from "../../constants/RoomConstant";
import RoomView from "../components/RoomView";
import FloorplanLegendItem from "../components/FloorplanLegendItem";
...
export default class FloorplanView extends Component {
  ...
  render() {
    return (
      <div className="floorplanview-main">
        ...
        <div className="floorplan-legend">
          <FloorplanLegendItem color={ROOM_COLOR.DARK_BLUE} text={"T < 15°C"} />
          <FloorplanLegendItem color={ROOM_COLOR.MEDIUM_BLUE} text={"15°C ≤ T < 20°C"} />
          <FloorplanLegendItem color={ROOM_COLOR.LIGHT_BLUE} text={"20°C ≤ T < 25°C"} />
          <FloorplanLegendItem color={ROOM_COLOR.RED} text={"T ≥ 25°C"} />
          <FloorplanLegendItem color={ROOM_COLOR.WHITE} text={"Off"} />
          <FloorplanLegendItem color={ROOM_COLOR.GREY} text={"No Data"} />
        </div>
      </div>
    );
  }
